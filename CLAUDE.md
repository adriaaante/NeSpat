...
- `certificate-guide.html` — руководство по выдаче со скриншотами
  (`assets/img/guide/`); из него же печатается PDF
...
## Грабли
- Подпись студии-разработчика в подвале сайта и в руководстве **убрана по
  просьбе клиента** — не возвращать ни в каком виде.
